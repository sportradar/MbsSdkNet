...
public class CashoutPlacementResponse : ContentResponseBase
{

  [JsonInclude]
  [JsonPropertyName("type")]
  private string Type => "cashout-placement-reply";
  ...
  {
    private readonly CashoutPlacementResponse instance = new CashoutPlacementResponse();
